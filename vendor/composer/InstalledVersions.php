 ...
 */
namespace _YabeOxybender\Composer;

use _YabeOxybender\Composer\Autoload\ClassLoader;
use _YabeOxybender\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_YabeOxybender\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
